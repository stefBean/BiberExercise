 ...
 */
class Student {
    constructor(name, age, isGraduated, birthDate) {
        this.name = name;
        this.age = age;
...
/* Task 1 - Part 2. Replace these three instances of the example Class Resource with instances
   of your own class */
model.add(new Student("Stefanie", 28, true, new Date(1996, 5, 15)));
model.add(new Student("Lucky", 25, false, new Date(1999, 2, 1)));
model.add(new Student("Bibsi", 32, true, new Date(1991, 11, 24)));
